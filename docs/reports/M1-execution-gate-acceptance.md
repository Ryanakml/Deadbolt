...
- Staging provenance: immutable image tag and OCI revision now derive from `RELEASE_COMMIT_SHA`; `/version.build_time` uses the reviewed commit's deterministic RFC3339 commit timestamp.
...
## Deployment and provenance validation

- Functional acceptance baseline: `f232f93b7db228861cb69f032b8a872392cd3061`
- Provenance-fix/deployment HEAD: `0be2f30b4ebc4941670bc3b39b9e1136528bb746`
- Foundation contracts on the provenance-fix HEAD: run `35447560879`, workflow run `#205`, status `SUCCESS`
- Staging Immutable Deploy: `#38`, run `35447576183`, result `SUCCESS`
- Workflow URL: `https://github.com/Ryanakml/Deadbolt/actions/runs/35447576183`
- Deployed commit: `0be2f30b4ebc4941670bc3b39b9e1136528bb746`
- The provenance-fix commit changes only `.github/workflows/staging-deploy.yml`; no runtime product source, tests, migrations, or task code changed.
...
| Hosted staging execution          | STAGING PASS        | Staging Immutable Deploy run 35447576183 SUCCESS on 0be2f30, exact tag/OCI revision, RFC3339 build time, /version commit/digest, and running RepoDigest verified |
...
The final immutable staging deployment below is the provenance-corrected replacement deployment. No staging identifiers below are invented.

### Immutable deployment

- Workflow: Staging Immutable Deploy `#38`
- Workflow URL: `https://github.com/Ryanakml/Deadbolt/actions/runs/35447576183`
- Run ID: `35447576183`
- Result: `SUCCESS`
- Deployed commit: `0be2f30b4ebc4941670bc3b39b9e1136528bb746`
- Public staging: `https://deadbolt.43.218.246.246.nip.io`
- Control-plane image tag: `ghcr.io/ryanakml/deadbolt/control-plane:0be2f30b4ebc4941670bc3b39b9e1136528bb746`
- Control-plane image digest: `ghcr.io/ryanakml/deadbolt/control-plane@sha256:ad734567f02e1f33d0e5c7fa1a183f4771afc2915f6fdf012ab0f60a0317fd8a`
- PostgreSQL image digest: `ghcr.io/ryanakml/deadbolt/postgres@sha256:226c087c96f78529eb1206eab690989747f66c07d6fa63ce9f72488baa63aa58`
- Control-plane OCI label: `org.opencontainers.image.revision=0be2f30b4ebc4941670bc3b39b9e1136528bb746`
- Deterministic RFC3339 build time: `2026-09-19T21:03:07+07:00`
- The build invocation used `COMMIT_SHA=0be2f30b4ebc4941670bc3b39b9e1136528bb746`, `BUILD_TIME=2026-09-19T21:03:07+07:00`, and the exact OCI revision label above.
- `/version` returned: `version 0.1.0`, `commit 0be2f30b4ebc4941670bc3b39b9e1136528bb746`, `build_time 2026-09-19T21:03:07+07:00`, `image_digest ghcr.io/ryanakml/deadbolt/control-plane@sha256:ad734567f02e1f33d0e5c7fa1a183f4771afc2915f6fdf012ab0f60a0317fd8a`, `runtime_mode hosted`
- The running container declared the same immutable digest and `RepoDigests` independently returned `ghcr.io/ryanakml/deadbolt/control-plane@sha256:ad734567f02e1f33d0e5c7fa1a183f4771afc2915f6fdf012ab0f60a0317fd8a`.
...
- The functional one-task, A-to-B-to-C, browser/SSE, tenant/pool, and invalid-output runs below were executed on the earlier `f232f93b7db228861cb69f032b8a872392cd3061` runtime before this provenance-only workflow correction. Commit `0be2f30b4ebc4941670bc3b39b9e1136528bb746` changes only the staging workflow metadata generation; product/runtime source is unchanged.
...
Automated M1 failure-matrix coverage is complete for F-01, F-02, F-04, F-08, F-11, F-18, F-21, F-27, and F-28 at the stated test boundaries. Foundation contracts PASS on provenance-fix/deployment HEAD `0be2f30b4ebc4941670bc3b39b9e1136528bb746` (run `35447560879`, #205).

Hosted staging is complete: immutable build-once deployment run `35447576183` deployed commit `0be2f30b4ebc4941670bc3b39b9e1136528bb746` with tag, OCI revision, RFC3339 build time, `/version` commit/image digest, and running RepoDigest aligned to the reviewed release commit. Literal `one task` run `0c31f13a-035a-4ec1-8b2a-61767c963c44` succeeded, followed by literal `A -> B -> C` run `08c86672-19d6-4ff9-9a2c-65e4b36275d2` with final sequence `13` and committed output. Manual browser, auth, and SSE acceptance was witnessed on run `92d6ea0e-93f8-4c50-922c-1b5af8e76d79`. Hosted negatives for wrong pool, cross-tenant run read and SSE, and invalid output were observed as recorded above. F-08 remains automated real-PostgreSQL evidence and is not claimed as manual hosted duplicate completion.
